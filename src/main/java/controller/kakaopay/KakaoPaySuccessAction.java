...
public class KakaoPaySuccessAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			boolean approveSuccess = KakaoPayApproveUtil.approve(tid, pgToken, orderPk, accountPk, CID, SECRET_KEY_DEV);
			...
			session.removeAttribute("reservedCartDatas");
			...
			// 선점 재고 복구
			ArrayList<CartDTO> reversedCartDatas = (ArrayList<CartDTO>) session.getAttribute("reservedCartDatas");
