...
public class OrnamentListPageAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("[로그] controller.ornamentShop.OrnamentListPageAction | [상품 목록 페이지 로드]");
		// 상품 데이터들을 비동기로 채워넣음 (servlet 패키지의 ItemListPagenationServlet 참고)
		...
		/* 데이터를 동기로 채워넣다가 ajax를 이용한 비동기 페이지네이션을 통해 불러오는 것으로 변경하여 코드 폐기
		 * 
		 * // 우선 출력 조건 받기
