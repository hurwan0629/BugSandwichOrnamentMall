...
<!-- ▼▼▼모달창 cdn ▼▼▼ -->
  ...
  /* 위치 살짝 위로 올리기 */
  #wish-btn {
    top: -10px !important; /* 위치를 약간 위로 조정 */
  }

/* 버튼을 클릭했을 때 하얀색 배경과 빨간색 하트로 바뀌도록 설정 */
/* 버튼을 클릭했을 때 하얀색 배경과 빨간색 하트로 바뀌도록 설정 */
#wish-btn.active, #wish-btn:active {
  background-color: white !important; /* 하얀색 배경 */
  color: red !important; /* 글씨 색상 빨간색 */
  border: none !important; /* 테두리 제거 */
}

/* 클릭 상태에서 아이콘 색상 빨간색으로 변경 */
#wish-btn.active i, #wish-btn:active i {
  color: red !important; /* 하트 아이콘 빨간색 */
}

  #add-to-cart:hover, #buy-now:hover {
    background-color: #4E3B2D !important; /* 커서 올렸을 때 어두운 브라운색 */
    border-color: #4E3B2D !important; /* 테두리 색도 동일하게 변경 */
    color: white !important; /* 텍스트는 흰색 */
  }
...
.pagenation-button {
  ...
  color: #8B6A4D !important;                 /* 중간 커피색 */
  border: 1px solid #D1B29A !important;      /* 테두리 연한 베이지 */
...
.pagenation-button.active {
  background-color: #6F4F3A !important;      /* 진한 브라운 */
  color: white !important;
...
#review-page-list {
  margin-top: 30px !important;              /* 간격을 100px로 넉넉하게 조정 */
  margin-bottom: 50px;
}
</style>
</head>
				...
				<div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
					<div class="row g-4 single-product item-card content rounded">
						...
						<div class="col-xl-6 position-relative">
						  ...
						  <!-- Wish 버튼을 상품 이미지의 오른쪽 위에 배치 -->
						  <a href="#" id="wish-btn"
						    data-item-pk="${empty itemData.itemPk ? 0 : itemData.itemPk }"
						    data-wished="${isWished}"
						    class="wish-pill d-flex align-items-center justify-content-center bg-light rounded-pill px-3 py-2 position-absolute top-0 end-0 m-3">
						...
						<div class="col-xl-6">
						  ...
						  <div class="input-group mb-5" style="width: 100px;">
						    ...
						    <input id="item-count" type="text" class="form-control form-control-sm text-center border-0" value="1"
						      pattern="^[1-9][0-9]?$">
						    <div class="">
