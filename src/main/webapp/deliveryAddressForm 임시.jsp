...
<body>
	...
	<div class="container-fluid page-header py-5">
		<h1 class="text-center text-white display-6 wow fadeInUp"
			data-wow-delay="0.1s">배송지 등록</h1>
	</div>
	<!-- Single Page Header End -->

	<div class="container-fluid overflow-hidden py-5">
		<div class="container py-5 content item-card rounded">
			<h1 class="mb-4 wow fadeInUp text-center" data-wow-delay="0.1s">배송지
				추가</h1>
			<div class="container-fluid bg-light overflow-hidden py-5 rounded">
				<div class="container py-5">
					<div class="row g-2 justify-content-center">
						<div class="col-md-8 col-lg-2 col-xl-5" data-wow-delay="0.1s">
							<form id="regist-address-form" action="registDiliveryAddress.do"
								method="POST">
       ...
       required>
								...
								<div class="form-item">
									...
									<input type="text" class="form-control mt-2"
										...
										readonly> <input type="text" class="form-control mt-2"
								...
								<div class="row justify-content-center mt-5">
									<div class="col-6">
										<button id="add-address" type="submit" class="btn btn-success w-100 py-3">등록</button>
									</div>
								</div>
							</form>
						</div>
