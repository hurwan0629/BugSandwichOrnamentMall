...
<body>
	...
	<div class="container-fluid overflow-hidden py-5">
		<div class="container py-5  content item-card rounded">
			<h1 class="mb-4 wow fadeInUp" data-wow-delay="0.1s">배송지 목록</h1>
			<form action="#">
				<div class="row g-5">
					...
					<div class="col-md-12 col-lg-12 col-xl-12 wow fadeInUp"
							...
							<table class="table" id="addressTable">
								<thead>
									<tr class="text-center">
										<th scope="col" class="text-start" style="width: 25%;">배송지
											이름</th>
										...
										<tr class="text-center">
											...
											<td class="py-4 text-center"><c:choose>
													...
													<c:otherwise>
														...
														<button type="button"
															class="set-default-address btn btn-primary rounded-pill py-1 px-2"
															data-addresspk="${addressData.addressPk }">기본
															배송지로 설정</button> 
													</c:otherwise>
												</c:choose></td>
											<td class="py-4 text-center">
												<button type="button"
												class="delete-address btn btn-primary rounded-pill py-1 px-2"
												data-addresspk="${addressData.addressPk }"
												data-isdefault="${addressData.defaultAddress }">삭제</button> 
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="text-end mt-3">
							...
							<a type="button" id="regist-address"
								...
								class="btn btn-primary rounded-pill px-4 py-2">배송지 등록하기</a>
								</div>
							</c:if>
				</div>
				</div>
