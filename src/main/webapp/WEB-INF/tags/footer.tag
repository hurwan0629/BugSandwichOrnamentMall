				...
				<div class="row g-4">
					...
					<div class="col-md-5">
							...
							<div
								...
								<img src="images/santa-sledge.png" alt="sledge icon" style="width: 60px">
								<!-- <i class="fas fa-map-marker-alt fa-2x" style="color: #ffffff;"></i> -->
							</div>
							<h5 class="footer-title">주소</h5>
							<a
								href="https://map.naver.com/p/search/%EC%BD%94%EB%A6%AC%EC%95%84%20it%20%EA%B0%95%EB%82%A8/place/37285910?c=16.97,0,0,0,dh&placePath=/home?entry=bmp&from=map&fromPanelNum=2&timestamp=202512300937&locale=ko&svcName=map_pcv5&searchText=%EC%BD%94%EB%A6%AC%EC%95%84%20it%20%EA%B0%95%EB%82%A8"
								target="_black" alt="코리아IT강남 주소">
								<p class="mb-1">서울 강남구 테헤란로 146</p>
								<p>현익빌딩 3, 4층</p>
							</a>
							<div id="kakao-map"
								style="width: 85%; height: 220px; border-radius: 12px; overflow: hidden; margin-top: 12px; border: 2px solid #000;"></div>
					...
					<div class="col-md-3">
						...
						<p>
							<strong>유진</strong> : <a href="https://bobaejin.tistory.com/"
								target="_blank"> <span class="rainbow">유진개발일기</span></a>
						</p>
						<p>
							<strong>변희인</strong> : <a
								href="https://blog.naver.com/qusakfdl111" target="_blank"> <span
								class="rainbow">JAVA_STUDY_변희인</span></a>
						</p>
						<p>
							<strong>송이</strong> : <a href="https://kkobug2.tistory.com/"
								target="_blank" class="rainbow"><span class="rainbow">꼬부기의
									코딩수련소</span></a>
						</p>
						<p>
							<strong>허완</strong> : <a
...
<!-- Kakao Map -->
<script
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0c71276096e973676c7e82c35122a621&libraries=services"></script>
<script>
	// 카카오맵 로딩 이후 실행
	(function initKakaoMap() {
		// 지도 표시할 div가 없으면 종료 (다른 페이지에서 푸터 구조가 다를 때 대비)
		...
		var address = '서울 강남구 테헤란로 146'; // 너가 원하는 주소
		...
		geocoder
				.addressSearch(
						...
						function(result, status) {
							...
							// 인포윈도우(말풍선) - 필요 없으면 삭제해도 됨
							var info = new kakao.maps.InfoWindow(
									{
										content : '<div style="padding:6px 10px; font-size:12px;">코리아IT아카데미 강남점</div>'
									});
